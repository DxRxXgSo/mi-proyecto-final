...
export default function Formulario() {
  // Detecta automáticamente si usa localhost o la URL de Render
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    telefono: '',
    fecha_nacimiento: '', // Corregido: snake_case para la DB
    mensaje: ''
  });
            ...
            <div className="card-body p-4 bg-white">
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-3">
                  ...
                  <div className="form-text small">Mínimo 10 dígitos</div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <Link to="/" className="text-decoration-none fw-bold small" style={{ color: '#7b61ff' }}>
                    ← Volver al Inicio
                  </Link>
                </div>
              </form>
